...
一套将 **221 基础色**标准色卡做成 Minecraft 实心色块的像素画 Mod。
...
- 加载器：Forge 47.2.0+
- 色卡：221 基础色（A–H/M 系列，色准已校准与官方色卡完全一致）
...
| 功能 | 说明 |
|---|---|
| 221 基础色块 | 每个色号一个实心色块，颜色使用 标准 RGB，色准标准 |
...
- 按 **G** 打开主界面
- **按钮1：彩色方块颜色选取** — 浏览全部色号网格，点击任意色号 → 对应物品一组（64个）进入背包，支持连续选择
- **按钮2：输入想用的色号** — 在输入框中输入色号（如 A1、B5、M3），点击确认 → 自动放入快捷栏一组（64个）
- **按钮3：导入外部图纸** — 开发中，敬请期待

### 创造模式标签页

- 在创造模式物品栏中切换到 彩色方块 系列标签页
